...
class SearchPanel(tk.Frame):
    ...
    def _criar_widgets(self):
        ...
        # Frame de busca
        search_frame = tk.Frame(self, bg=self.theme.bg_frame, relief=tk.FLAT)
        ...
        self.btn_buscar.pack(fill=tk.X, padx=10, pady=(8, 12))
        ...
        tk.Label(
            ...
            bg=self.theme.bg_frame
        ).pack(pady=(8, 6), padx=10)
        
        sugestoes_frame = tk.Frame(search_frame, bg=self.theme.bg_frame)
        sugestoes_frame.pack(fill=tk.X, padx=10, pady=(0, 10))
        
        cidades_sugeridas = ["Carambeí", "Curitiba", "São Paulo"]
