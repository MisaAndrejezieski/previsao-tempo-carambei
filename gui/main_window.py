...
class MainWindow:
    ...
    def _setup_ui(self):
        ...
        self.notebook.add(self.weather_display, text="Hoje")
    ...
    def _criar_top_bar(self, theme):
        ...
        top_bar = tk.Frame(self.main_container, bg=theme.bg_frame, height=50)
        ...
        titulo.pack(side=tk.LEFT, padx=20, pady=8)
    ...
    def carregar_cidade(self, cidade: str):
        ...
        if not cidade or not cidade.strip():
            self._atualizar_status("Digite o nome de uma cidade", erro=True)
            return
    ...
    def _mostrar_erro(self, mensagem: str):
        ...
        self.search_panel.mostrar_carregando(False)
        self._atualizar_status(f"Erro: {mensagem}", erro=True)
